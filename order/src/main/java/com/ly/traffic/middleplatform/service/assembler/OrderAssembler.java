...
public class OrderAssembler {
     ...
     * @return 1
     */
    public static OrderAggregate dtoToDo(CreateOrderRequestDto createOrderRequestDto, OrderAggregate orderAggregate) {
    ...
    /**
     * DTO 转 CancelOrder领域对象
     * @param dto 1
     * @return 1
     */
    public static CancelAggregate dtoToDo(CancelOrderRequestDto dto, CancelAggregate cancelAggregate) {
        CancelOrder cancelOrder = new CancelOrder();
        cancelOrder.setMainOrderNo(dto.getMainOrderNo());
        cancelOrder.setType(dto.getType());
        cancelOrder.setReasoncode(dto.getReasonCode());
        cancelOrder.setReason(dto.getReason());
        cancelOrder.setMemberid(dto.getMemberId());
        cancelOrder.setUnionid(dto.getUnionId());
        cancelOrder.setOpenid(dto.getOpenId());
        cancelOrder.setApplytime(dto.getApplyTime());
        cancelAggregate.setCancelOrder(cancelOrder);
        return cancelAggregate;
    }
    ...
    public static void main(String[] args) {
        ...
        OrderAggregate orderAggregate = new OrderAggregate(null);
        dtoToDo(createOrderRequestDto, orderAggregate);
